...
import { Create, SimpleForm, TextInput, DateInput, SelectInput,required, maxLength } from 'react-admin'
import RichTextInput from 'ra-input-rich-text';
import { BackendContext } from '../../../State/BackendState'
import { getCategoriesAndLanguages, getDirItems } from '../AdminFunctions'

const ListenArticleCreate = (props) => {
    ...
    return (
        <Create title='Create a Listen Article' {...props} >
            <SimpleForm>
...
export default ListenArticleCreate
