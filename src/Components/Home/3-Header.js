...
function Header() {
  ...
  const { languagesGlobal, languageSelectedGlobal } =
    ...
    <div className="headerDiv">
      ...
      <div className="titleDiv">
        <div className="backgroundImage">
          ...
          <h1>All U</h1>
          <h2>
            Learn English, Spanish, German, French and more all in one place for
            free. Join our community and help others become proficient in any
            language!
          </h2>
        </div>
      </div>
