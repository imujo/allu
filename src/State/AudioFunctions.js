...
export const onScrub = (value, intervalRef, audioRef, setTime, settrackPercentage, settrackProgress) => {
...
export const onScrubEnd = (isPlaying, setisPlaying, intervalRef, audioRef, setTime, settrackProgress, settrackPercentage) => {
    if (!isPlaying) {
      setisPlaying(true);
    }
...
export const startTimer = (intervalRef, audioRef, setisPlaying, setTime, settrackProgress, settrackPercentage) => {
    clearInterval(intervalRef.current);
